    ...
    <div className="space-y-6 max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input value={form.batchId} onChange={e => update("batchId", e.target.value)} placeholder="BATCH-2025-XXXX" required />
              </div>
              <div className="space-y-2">
                <Label>Manufacturer Name</Label>
                <Input value={form.manufacturer} onChange={e => update("manufacturer", e.target.value)} required />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input type="date" value={form.mfgDate} onChange={e => update("mfgDate", e.target.value)} required />
              </div>
              <div className="space-y-2 sm:col-span-2">
                <Label>Expiry Date</Label>
                <Input type="date" value={form.expDate} onChange={e => update("expDate", e.target.value)} required />
              </div>
            </div>
            <div className="space-y-2">
      ...
      {showQR && form.batchId && (
        <QRCodeDisplay
          ...
          title={`QR: ${form.batchId} — License: ${form.licenseNumber}`}
        />
      )}
    </div>
  );
